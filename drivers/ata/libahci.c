...
#ifdef CONFIG_BSP_SATA_FBS
static int fbs_en = CONFIG_BSP_SATA_FBS;
...
extern void bsp_sata_set_fifoth(void *mmio);
#endif
#ifdef CONFIG_BSP_SATA
extern void bsp_sata_reset_rxtx_assert(unsigned int port_no);
extern void bsp_sata_reset_rxtx_deassert(unsigned int port_no);
#endif
...
#ifdef CONFIG_BSP_SATA
		bsp_sata_reset_rxtx_assert(ap->port_no);
		bsp_sata_reset_rxtx_deassert(ap->port_no);
#endif
		goto fail;
	}
