...
static void fmc100_dma_wr_op_config(struct fmc_host *host, struct fmc_spi *spi)
{
	unsigned int reg;
...
static void fmc100_dma_rd_op_config(struct fmc_host *host, struct fmc_spi *spi)
{
	unsigned int reg;
	unsigned int block_num;
	unsigned int block_num_h;
