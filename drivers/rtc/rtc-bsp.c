...
#define RTC_REG_LOCK4	0x19C
    ...
    defined(CONFIG_ARCH_SS812V100) || defined(CONFIG_ARCH_SS813V100) || \
    ...
    defined(CONFIG_ARCH_SS013V100)  || defined(CONFIG_ARCH_SS919V100) || \
	defined(CONFIG_ARCH_SS319V100) || defined(CONFIG_ARCH_SS015V100)
...
#if defined(CONFIG_ARCH_SS919V100) || defined(CONFIG_ARCH_SS319V100) || \
    defined(CONFIG_ARCH_SS015V100)
...
static int bsp_rtc_init(struct bsp_rtc *rtc)
{
	...
	defined(CONFIG_ARCH_SS312V100) || defined(CONFIG_ARCH_SS313V100) || \
	defined(CONFIG_ARCH_SS918V100) || defined(CONFIG_ARCH_SS318V100) || \
	defined(CONFIG_ARCH_SS612V100) || defined(CONFIG_ARCH_SS011V100) || \
	defined(CONFIG_ARCH_SS012V100) || defined(CONFIG_ARCH_SS015V100) || \
	defined(CONFIG_ARCH_SS013V100) || defined(CONFIG_ARCH_SS319V100)
	bsp_rtc_write(spi_reg, RTC_CLK_CFG, 0x02);
#elif defined(CONFIG_ARCH_SS101V200) || defined(CONFIG_ARCH_SS101V500) || \
	defined(CONFIG_ARCH_SS101V300) || defined(CONFIG_ARCH_SS101V600) || \
	defined(CONFIG_ARCH_SS528V100) || defined(CONFIG_ARCH_SS625V100) || \
    defined(CONFIG_ARCH_SS524V100) || defined(CONFIG_ARCH_SS522V100) || \
	defined(CONFIG_ARCH_SS615V100) || defined(CONFIG_ARCH_SS919V100) || \
	defined(CONFIG_ARCH_SS522V101)
	bsp_rtc_write(spi_reg, RTC_CLK_CFG, 0x03);
#else
	bsp_rtc_write(spi_reg, RTC_CLK_CFG, 0x01);
#endif
