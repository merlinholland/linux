	...
	if (phy == NULL) {
		...
		if (of_phy_is_fixed_link(node)) {
			*ret = of_phy_register_fixed_link(node);
			 ...
			 */
			phy = of_phy_connect(priv->ndev, of_node_get(node), &bsp_femac_adjust_link, 0,
...
static const struct of_device_id bsp_femac_match[] = {
	...
	{
		.compatible = "vendor,ss812v100-femac",
	},
	{
		.compatible = "vendor,ss612v100-femac",
	},
	{
		.compatible = "vendor,ss312v100-femac",
	},
	{
		.compatible = "vendor,ss313v100-femac",
	},
	{},
};
